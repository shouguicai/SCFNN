...
The training set contains 3000 samples sampled uniformly with 1.82\--8.65 km in range,the test set is another 300 data sampled with the same range. The noise in the simulations is all set to be complex gaussian white noise.
