...
\caption{The learned sparse representation model.The learned feature space spans data(csdm) space likelihood that few basis functions $\phi$ explain a given data.}
\end{figure}
